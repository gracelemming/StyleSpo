...
public class LoginTest {
    ...
    public void loginTest() {
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.accountCheck), withText("Don't have an account?"),
                        withParent(withParent(withId(R.id.activity_main))),
                        isDisplayed()));
        textView.check(matches(withText("Login Failed")));
    }
